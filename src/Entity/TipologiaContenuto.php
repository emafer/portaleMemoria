...
use App\Repository\TipologiaContenutoRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TipologiaContenutoRepository::class)]
class TipologiaContenuto
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: Documento::class, mappedBy: 'tipologiaContenuto')]
    ...
    public function addDocumenti(Documento $documenti): static
    {
        if (!$this->documenti->contains($documenti)) {
            ...
            $documenti->setTipologiaContenuto($this);
        }
    ...
    public function removeDocumenti(Documento $documenti): static
    {
        if ($this->documenti->removeElement($documenti)) {
            ...
            if ($documenti->getTipologiaContenuto() === $this) {
                $documenti->setTipologiaContenuto(null);
            }
        }
